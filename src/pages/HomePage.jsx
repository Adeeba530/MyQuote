...
import Heading from "./components/commons/Heading.jsx";
import Quote from "./components/commons/quote.jsx";
import { useEffect, useState } from "react";

function App() {
  const [hello, setHello] = useState(true); useEffect(() => {
    console.log("Welcome to the work. This website is a living archive of my research and philosophy on technology, consciousness, and human flourishing. Explore the themes, dive into the writings, and join the conversation about how we can build a better digital future together.");
  }, [hello])
    ...
    <div className="max-w-[90%] ml-12 lg:ml-40 pr-6 pt-12 pb-32">
      ...
      <div className="mt-20 md:mt-28">
        ...
        <div className="space-y-12 md:space-y-16">
          ...
          />
          <button onClick={() => setHello(!hello)}>Hello me</button>
          <Quote
      ...
      <footer className="mt-16 pt-6 pb-10">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="text-center text-base text-[#c9d1d9] font-medium tracking-wide">
            © 2026 Kenneth Reitz.
            <span className="ml-2 underline decoration-dotted decoration-1 underline-offset-4 hover:decoration-solid transition-all duration-200 cursor-pointer">
              Made with love.
            </span>
          </div>
